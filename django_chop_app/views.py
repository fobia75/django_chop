...
def create_order(request):
    if request.method == "POST":
        ...
        client_product_1 = Order(connection_client= client, connection_product= product_1, total_price= Order.total_price(), quantity= 1)
        client_product_2 = Order(connection_client= client, connection_product= product_2, total_price= Order.total_price(), quantity= 2)
